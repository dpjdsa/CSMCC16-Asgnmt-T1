 ...
 * A multi-threaded solution which creates a mapper for the input file, a combiner for each airport and a reducer summing the flight,
 * Also error checks and corrects file input. Outputs as text results to screen but also writes as CSV file
